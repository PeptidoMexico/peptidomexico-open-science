...
export const COA_SCHEMA: AnySchema = {
...
function mapError(error: ErrorObject): CoaValidationError {
  return {
...
export function validateCoa(value: unknown): CoaValidationResult {
...
export function assertValidCoa(value: unknown): void {
